...
var airbnbArray = {
	"listing":{
		...
		/*airbnbArray.search_results.forEach(function(el){
			...
			document.write("<b>Baños : </b>" + el.listing.bathrooms + "<br><hr><br>");
